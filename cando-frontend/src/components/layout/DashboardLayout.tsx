    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="lg:hidden">
          <button
            type="button"
            className="fixed bottom-4 right-4 rounded-full bg-blue-600 p-3 text-white shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
